...
window.WAPI.isConnected = function (done) {
    ...
    let retuns = false
    try {
        let isConnected = document.querySelectorAll('*[data-icon="alert-phone"]').length ? false : true;
        let isConnected_two = document.querySelectorAll('*[data-icon="chat"]').length ? false : true;
